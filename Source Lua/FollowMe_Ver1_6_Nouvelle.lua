...
function build_holder(wnd, x, y)
  ...
  -- VER1.6 : Icon drawn with pure imgui - no DrawList (unreliable in FlyWithLua)
  local l_color = l_in_flight and 0xFF666666 or 0xFFFFFFFF

  -- Rounded border button (transparent, just the border visible as circle-like frame)
  imgui.SetCursorPos(l_cx - 11, l_cy - 11)
  imgui.PushStyleColor(imgui.constant.Col.Button,        0x00000000)
  imgui.PushStyleColor(imgui.constant.Col.ButtonHovered, 0x00000000)
  imgui.PushStyleColor(imgui.constant.Col.ButtonActive,  0x00000000)
  imgui.PushStyleColor(imgui.constant.Col.Border,        l_color)
  imgui.PushStyleVar(imgui.constant.StyleVar.FrameBorderSize, 1)
  imgui.PushStyleVar(imgui.constant.StyleVar.FrameRounding,   11)
  imgui.Button("##border", 22, 22)
  imgui.PopStyleVar()
  imgui.PopStyleVar()
  imgui.PopStyleColor()
  imgui.PopStyleColor()
  ...
  imgui.SetCursorPos(l_cx - l_text_width / 2, l_cy - l_text_height / 2 - 4)
  imgui.PushStyleColor(imgui.constant.Col.Text, l_color)
  imgui.TextUnformatted(l_text)
  imgui.PopStyleColor()

  -- Red diagonal bar when in flight
  if l_in_flight then
    imgui.SetCursorPos(l_cx - 6, l_cy - 8)
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF0000FF)
    imgui.TextUnformatted("/")
    imgui.PopStyleColor()
  end
