...
function closed_window(wnd)
    window_is_open = false
    fm_window      = nil   -- destroy géré par FlyWithLua, on remet nil
end
...
-- NOTE : toggle_window est traité dans do_every_frame (followme.lua)
--        car float_wnd_set_visible est interdit dans un callback ImGui
