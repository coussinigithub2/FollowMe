...
function airport_watchdog()
    ...
    if l_new_ICAO ~= _prev_icao_check then
        ...
        fm_log("FollowMe airport_watchdog : ICAO changé → " .. l_new_ICAO)
    end
end
...
function load_airport_if_needed()
    ...
    fm_log("FollowMe airport_data : " .. curr_ICAO .. " chargé — "
...
function full_reset()
    ...
    initialise_airport()
    initialise_routes()
    fm_log("FollowMe VER1.12 : full_reset() completed")
end
...
fm_log("FollowMe airport_data.lua chargé")
